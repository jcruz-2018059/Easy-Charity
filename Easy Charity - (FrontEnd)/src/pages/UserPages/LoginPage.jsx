                    ...
                    <div className="col-md-6 p-md-5">
                        ...
                        <form>
                            ...
                            <div className="text-center pt-1 mb-5 row">
                                <button onClick={(e) => login(e)} className="btn btn-danger  col rounded-0" type="button">Iniciar sesión</button>
                            </div>
                        </form>
                    </div>
                    <div className="col-md-6">
                        <img src="/src/assets/login.png" alt="Imagen de inicio de sesión" className="img-fluid" />
                    </div>
                </div>
            </div>
        </>
